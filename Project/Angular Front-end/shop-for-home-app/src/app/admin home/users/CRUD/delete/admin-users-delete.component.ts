...
export class AdminUsersDeleteComponent{
    ...
    deleteUser(){
        if (this.userId) {
            this.client.userDelete(this.userId).pipe(
                catchError((error) => {
                ...
                if (data) {
                    ...
                    ActionToast.showToast(ActionToast.apps.userApp, action, this.message, ActionToast.action.successColor);
                }
